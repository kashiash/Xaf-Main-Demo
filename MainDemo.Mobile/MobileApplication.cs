...
namespace MainDemo.Mobile {
    ...
    public partial class MainDemoMobileApplication : MobileApplication {
        ...
        private DevExpress.ExpressApp.Security.AuthenticationMixed mixedAuthentication1;
        ...
        static MainDemoMobileApplication() {
            ...
            MobileApplication.EnableExtendedDetailViewLayout = true;
        }
        ...
        private void MainDemoMobileApplication_CustomizeApplicationConfig(object sender, CustomizeApplicationConfigEventArgs e) {
            e.ApplicationConfig.WindowsStorePublisherName = "DevExpress";
        }
